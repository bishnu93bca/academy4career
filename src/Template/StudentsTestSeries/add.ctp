        ...
        <?= $this->Form->create($StudentsTestSeries,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Student Test Series Name" name="student_test_series_name" required="">
            </div>
             <div class="col-md-12 form-group1">
              <label class="control-label">Total Test</label>
              <input type="text" placeholder="Total Test" name="test_series_total_test" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
            <div class="col-md-12 form-group1">
              <label class="control-label">Student Test Series Description</label>
              <textarea type="text" placeholder="Student Test Series Description" name="student_test_series_description" required=""></textarea>
            </div>
            <div class="col-md-12 form-group1">
              <label class="control-label">Price</label>
              <input type="text" placeholder="Price" name="student_test_series_price" required="">
            </div>
