<div class="validation-system">
        ...
        <?= $this->Form->create($ClassTestSeriesQuestions,['enctype'=>"multipart/form-data"]) ?>
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Questions" name="question" required="">
            </div>
            ...
            <div class="col-md-6 form-group1">
              ...
              <input type="text" placeholder="Answer One" name="answer_one" required="">
            </div>
            <div class="col-md-6 form-group1 form-last">
              <label class="control-label">Answer Two</label>
              <input type="text" placeholder="Answer Two" name="answer_two" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
             <div class="vali-form">
            <div class="col-md-6 form-group1">
              ...
              <input type="text" placeholder="Answer Three" name="answer_three" required="">
            </div>
            <div class="col-md-6 form-group1 form-last">
              <label class="control-label">Answer Four</label>
              <input type="text" placeholder="Answer Four" name="answer_four" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
