<div class="validation-system">
        ...
        <?= $this->Form->create($magazines,['enctype'=>"multipart/form-data"]) ?>
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Magazine Name" name="magazine_name" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
            <div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Published Date</label>
              <input type="Date" placeholder="" name="published_date" required="">
            </div>
             <div class="clearfix"> </div>
            <div class="col-md-12 form-group1 group-mail">
              <?php 
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Magazine Name" name="magazine_publisher" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
             <div class="clearfix"> </div>
            <div class="col-md-12 form-group1 ">
              ...
              <textarea name="magazine_description" placeholder="Magazine Description....." required=""></textarea>
            </div>
             <div class="clearfix"> </div>
