        ...
        <?= $this->Form->create($blogs,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Magazine Name" value="<?=h($blogs->post_name)?>" name="post_name" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
            <div class="col-md-12 form-group1 ">
              <label class="control-label">Post Description</label>
              <textarea name="post_description" placeholder="Post Descriptio....." required=""><?=h($blogs->post_description)?></textarea>
            </div>
