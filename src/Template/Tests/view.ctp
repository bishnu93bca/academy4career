...
<?php  for ($i=0; $i < 5; $i++) { 
	...
	$arrayName[] = ["what is 10+4?","12","14","16","16","B"];
}
...
//   $t=$Time->time;
//   }else{
//     $t=strtotime($Questions->test->time) - strtotime('TODAY');
// }
?>
