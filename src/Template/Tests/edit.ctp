    ...
    <div class="validation-form">           
        <?= $this->Form->create($Tests,['enctype'=>"multipart/form-data"]) ?>
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" value="<?php echo $Tests->name;?>" name="name" required="">
            </div>
            <div class="col-md-12 form-group1">
              <label class="control-label">Description</label>
               <textarea name="description" placeholder="Description....." required=""><?php echo $Tests->description;?></textarea>
            </div>
            <div class="col-md-12 form-group1">
