        ...
        <?= $this->Form->create($StudyMaterials,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" value="<?=h($StudyMaterials->study_material_name)?>" placeholder="Study Material Name" name="study_material_name" required="">
            </div>

             <div class="clearfix"> </div>
            <div class="col-md-12 form-group1 ">
              <label class="control-label">Study Material Description</label>
              <textarea name="study_material_description" placeholder="Study Material Description....." required=""><?=h($StudyMaterials->study_material_description)?></textarea>
            </div>
            <div class="col-md-12 form-group1">
              <label class="control-label">Study Material Price</label>
              <input type="text" value="<?=h($StudyMaterials->study_material_price)?>" placeholder="Study Material Price" name="study_material_price" required="">
            </div>
            <div class="col-md-12 form-group1">
              <label class="control-label">Study Material Year</label>
              <input type="text" value="<?=h($StudyMaterials->study_material_year)?>" placeholder="Study Material Year" name="study_material_year" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
