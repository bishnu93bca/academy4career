        ...
        <?= $this->Form->create($ImportantLinks,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Link Content" value="<?=h($ImportantLinks->link_content)?>" name="link_content" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
            <div class="col-md-12 form-group1">
              <label class="control-label">Link Url</label>
              <input type="text" placeholder="Link Url" value="<?=h($ImportantLinks->link_url)?>" name="link_url" required="">
            </div>
