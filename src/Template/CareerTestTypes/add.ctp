        ...
        <?= $this->Form->create($CareerTestTypes,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Career Test Type Name" name="career_test_type_name" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
             <div class="col-md-12 form-group1 group-mail">
              <?php 
                echo '<label for="image" class="control-label">Career Test Type Image</label>';
