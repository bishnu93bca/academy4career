        ...
        <?= $this->Form->create($EntranceExams,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Entrance Exam Name" name="entrance_name" required="">
            </div>        
             <div class="clearfix"> </div>
            <div class="col-md-12 form-group1 ">
              <label class="control-label">Entrance Exam Description</label>
              <textarea name="entrance_description" placeholder="Entrance Exam Description....." required=""></textarea>
            </div>
            <div class="col-md-12 form-group1 ">
