        ...
        <?= $this->Form->create($Courses,['enctype'=>"multipart/form-data"]) ?>
          <div class="vali-form">
            ...
            <div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="Course Name" value="<?=h($Courses->course_name)?>" name="course_name" required="">
            </div>
            <div class="col-md-12 form-group1">
            ...
            <div class="col-md-12 form-group1">
              ...
              <textarea placeholder="Course Description" name="course_desc" required=""><?=h($Courses->course_desc)?></textarea>
            </div>
            </div>
